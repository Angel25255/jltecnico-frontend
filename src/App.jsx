  ...
  const grupos = [
    ...
    },
    {
      ...
      modulos: [
        ...
        { id: "categorias", label: "Categorías", icon: IconoCategorias, visible: tienePermiso("CATEGORIAS_VER") },
        { id: "productos", label: "Productos", icon: IconoProductos, visible: tienePermiso("PRODUCTOS_VER") },
    ...
    },
    {
      ...
      modulos: [
        { id: "proveedores", label: "Proveedores", icon: IconoProveedores, visible: tienePermiso("PROVEEDORES_VER") },
        { id: "compras", label: "Compras", icon: IconoCompras, visible: tienePermiso("COMPRAS_VER") },
        { id: "kardex", label: "Kardex", icon: IconoKardex, visible: tienePermiso("KARDEX_VER") },
        { id: "tecnicos", label: "Gestión de Técnicos", icon: IconoTecnicos, visible: tienePermiso("TECNICOS_VER") },
